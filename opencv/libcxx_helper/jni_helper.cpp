...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM* vm, void* reserved) {
    JNIHepler::gJavaVM = vm;  // 전역 JavaVM 포인터 설정
    auto env = JNIHepler::getEnv();
    ...
    // 로컬 참조를 글로벌 참조로 변경
    JNIHepler::gClassLoader = env->NewGlobalRef(localClassLoader);
    JNIHepler::gFindClassMethod = env->GetMethodID(classLoaderClass, "findClass", "(Ljava/lang/String;)Ljava/lang/Class;");
